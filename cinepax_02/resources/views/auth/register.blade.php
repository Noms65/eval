                        ...
                        <div class="col-md-8">
                            ...
                            <form action="{{ route('registerSave') }}" method="POST">
                                ...
                                <div class="d-flex mb-5 align-items-center">
                                    ...
                                    <span class="ml-auto"><a href="{{ route('redirect_login') }}" class="forgot-pass">Page Log In
                                            </a></span>
                                </div>

                                <input type="submit" value="Log In" class="btn btn-block btn-primary">

                                <span class="d-block text-left my-4 text-muted">&mdash; or sign with &mdash;</span>
