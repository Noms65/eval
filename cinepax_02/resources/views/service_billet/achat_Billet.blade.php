                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        <form role="form" action="{{ route('valider_billet') }}">


                                            @if (count($list_billet_one) != 0)
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    @foreach ($list_billet_one as $billet)
                                                        <tr>
                                                            <td>{{ $billet->numero }}</td>
                                                                ...
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" required
                                                                            value="{{ $billet->idbillet }}"
                                                                            name="idBillet[]">Acheter
                                                                    </label>
                                                                </div>
                                                ...
                                                <div style="margin:5px;" class="btn-group">
                                                    <label>Type billets</label>
                                                    <select name="idType_billet">
                                                        @foreach ($type_billet as $type_billets)
                                                            <option value="{{ $type_billets->idtypes_billet }}">{{ $type_billets->types }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div style="margin:5px;" class="btn-group">
                                                    ...
                                                    <select name="idCategorie_film">
                                                        @foreach ($list_categorie as $list_categories)
                                                            <option value="{{ $list_categories->idcategorie_film }}">{{ $list_categories->categorie }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            @else
