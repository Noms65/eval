                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Liste Diffusion <small> Choisir votre film </small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                            @if (count($list_film) != 0)
                                                ...
                                                <tbody>
                                                    @foreach ($list_film as $list_films)
                                                        <tr>
                                                            <td>{{ $list_films->idseance}}</td>
                                                            <td>{{ $list_films->nom_salle}}</td>
                                                            <td>{{ $list_films->nom_film}}</td>
                                                            <td>{{ $list_films->heure}}</td>
                                                            <td>
