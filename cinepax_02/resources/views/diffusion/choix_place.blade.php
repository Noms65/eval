                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Choix du place <small>choisir votre place</small>
                        </h1>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form role="form" action="{{ route('valider_place') }}" >
                                    @csrf <!-- Ajouter le jeton CSRF pour la sécurité -->

                                    @if (count($liste_place) != 0)
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h4>Choix des Places - Salle : {{ $liste_place[0]->nom_salle }}</h4>
                                                @if (!empty($exception))
                                                    <p>{{ $exception }}</p>
                                                @endif
                                            </div>
                                        ...
                                        <div class="row">
                                            @foreach ($liste_place as $place)
                                                <div class="col-md-2 mb-3">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <h5 class="card-title">{{ $place->rangee }}</h5>
                                                            <p class="card-text">{{ $place->nom_place }}</p>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="place_rangee" id="{{ $place->nom_place }}"
                                                                    value="{{ $place->rangee }},{{ $place->nom_place }}">
                                        ...
                                        <!-- Ajouter les champs cachés avec les valeurs nécessaires -->
                                        <input type="hidden" name="idBillet" value="{{ $idBillet }}">
                                        <input type="hidden" name="idType_billet" value="{{ $idType_billet }}">
                                        <input type="hidden" name="idSeance" value="{{ $idSeance }}">
                                        <input type="hidden" name="idSalle" value="{{ $liste_place[0]->idsalle }}">

                                        <button type="submit" class="btn btn-primary mt-3">Valider</button>
                                    @else
                                        <p class="text-center alert-danger">Aucune donnée disponible</p>
                                    @endif
                                </form>
                            </div>
