...
<body>
    <button onclick="addPdf()" class="btn btn-primary py-0"
            class="fas fa-search">Pdf</button>
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="{{ route('accueille') }}"><i class="fa fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="active-menu" href="{{ route('empty') }}"><i class="fa fa-fw fa-file"></i> Empty Page</a>
                    </li>
                </ul>
